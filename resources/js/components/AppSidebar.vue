...
import { BookMarkedIcon, BookOpen, BrickWall, BriefcaseBusiness, Cog, FolderGit2, HandPlatter, LayoutGrid, Shield, ShieldPlus, Trophy, UserRoundCog, MessageSquare } from 'lucide-vue-next';
...
const kanwilNavItems: NavItem[] = [
    ...
    },
    {
        ...
        children: [
            ...
            { title: 'Data Jenis Pangkat/Golongan', href: '/admin/jenis-golongans' },
            { title: 'Data Saluran', href: '/admin/channels' },
            { title: 'Data Corporate Highlights', href: '/admin/corporate-highlights' },
        ]
    },
];
