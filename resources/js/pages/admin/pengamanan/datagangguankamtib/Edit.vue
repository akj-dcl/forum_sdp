...
const props = defineProps<{ datagangguankamtib: any, upts: any[] }>()

const form = useForm({
  _method: 'put',
  upt_id: String(props.datagangguankamtib.upt_id),
  tanggal_input: props.datagangguankamtib.tanggal_input,
  jenis_gangguan: props.datagangguankamtib.jenis_gangguan,
  uraian_singkat: props.datagangguankamtib.uraian_singkat,
  tanggal_kejadian: props.datagangguankamtib.tanggal_kejadian,
  waktu_kejadian: props.datagangguankamtib.waktu_kejadian,
  
  jumlah_korban: props.datagangguankamtib.jumlah_korban,
  detail_korban: props.datagangguankamtib.detail_korban || [],
  
  jumlah_barbuk: props.datagangguankamtib.jumlah_barbuk,
  detail_barbuk: props.datagangguankamtib.detail_barbuk || [],
  
  area_dirusak: props.datagangguankamtib.area_dirusak || '',
  pengamanan_tkp: props.datagangguankamtib.pengamanan_tkp || '',
  upaya_dilakukan: props.datagangguankamtib.upaya_dilakukan || '',
  permohonan_bantuan: props.datagangguankamtib.permohonan_bantuan || '',
...
function submit() {
  form.post(`/admin/data-gangguan-kamtibs/${props.datagangguankamtib.id}`, { forceFormData: true })
}
</script>

<template>
  <Head title="Edit Input Gangguan Kamtib" />
  <AppLayout>
    <div class="flex h-full flex-1 flex-col gap-4 p-4 md:p-6 bg-background text-foreground">
      ...
      <form @submit.prevent="submit" class="space-y-6">
        ...
        <div class="rounded-xl border bg-blue-50 p-6 shadow-sm border-blue-100 flex items-center justify-between">
            ...
            <input type="file" accept="application/pdf" @input="form.dokumentasi = $event.target.files[0]" class="text-sm file:mr-3 file:rounded file:border-0 file:bg-blue-600 file:text-white file:px-4 file:py-2 hover:file:bg-blue-700 cursor-pointer" />
        </div>
