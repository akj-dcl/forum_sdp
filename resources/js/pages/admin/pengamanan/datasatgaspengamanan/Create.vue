...
const form = useForm({
  ...
  // Razia
  tanggal_pelaksanaan_penggeledahan: '',
  waktu_pelaksanaan_penggeledahan: '',
  lokasi_kamar_penggeledahan: '',
  jumlah_anggota_penggeledahan: 0,
  hasil_penggeledahan: '',
  tindak_lanjut_penggeledahan: '',
  
  // Narkoba
  tanggal_pelaksanaan_narkoba: '',
  waktu_pelaksanaan_narkoba: '',
  jumlah_yang_dites_narkoba: 0,
  hasil_tes_narkoba: '',
  tindak_lanjut_hasil_tes: '',
})

function submit() {
  form.post('/admin/data-satgas-pengamanans')
}
</script>
