          ...
          <table class="w-full caption-bottom text-sm">
            ...
            <tbody class="[&_tr:last-child]:border-0">
              ...
              >
                ...
                <td class="p-4 w-3/5"> <div class="flex flex-wrap gap-1.5"> <span
                      v-for="perm in role.permissions.slice(0, 10)"
                      :key="perm.id"
                      class="inline-flex items-center rounded-md bg-emerald-100/80 px-2 py-1 text-[11px] font-semibold text-emerald-700 dark:bg-emerald-900/30 dark:text-emerald-400 border border-emerald-200 dark:border-emerald-800"
                    >
                      {{ perm.name }}
                    </span>
                    ...
                    <span
                      ...
                      class="inline-flex items-center rounded-md bg-muted px-2 py-1 text-[11px] font-medium text-muted-foreground border border-border"
                    >
                      +{{ role.permissions.length - 10 }} akses lainnya
                    </span>
