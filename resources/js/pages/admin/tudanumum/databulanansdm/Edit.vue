...
const props = defineProps<{ databulanansdm: any, upts: any[] }>()

const form = useForm({
  _method: 'put',
  upt_id: String(props.databulanansdm.upt_id),
  tanggal_input: props.databulanansdm.tanggal_input,
  jumlah_pegawai: props.databulanansdm.jumlah_pegawai,
  jumlah_pejabat_struktural: props.databulanansdm.jumlah_pejabat_struktural,
  jumlah_jf: props.databulanansdm.jumlah_jf,
  jumlah_petugas_penjagaan: props.databulanansdm.jumlah_petugas_penjagaan,
  jumlah_staff_pembinaan: props.databulanansdm.jumlah_staff_pembinaan,
  jumlah_staff: props.databulanansdm.jumlah_staff,
})
...
function submit() {
  form.post(`/admin/data-bulanan-sdms/${props.databulanansdm.id}`)
}
</script>
