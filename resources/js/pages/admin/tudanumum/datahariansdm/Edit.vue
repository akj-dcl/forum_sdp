...
const props = defineProps<{ datahariansdm: any, upts: any[] }>()

const form = useForm({
  _method: 'put',
  upt_id: String(props.datahariansdm.upt_id),
  tanggal_input: props.datahariansdm.tanggal_input,
  jumlah_pegawai_keseluruhan: props.datahariansdm.jumlah_pegawai_keseluruhan,
  
  kehadiran_pegawai: props.datahariansdm.kehadiran_pegawai || { hadir: 0, cuti: 0, sakit: 0, ijin: 0 },
  pelanggaran_sdm: props.datahariansdm.pelanggaran_sdm || '',
})
...
function submit() {
  form.post(`/admin/data-harian-sdms/${props.datahariansdm.id}`)
}
</script>
