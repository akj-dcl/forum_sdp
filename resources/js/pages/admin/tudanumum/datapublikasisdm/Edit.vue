...
const props = defineProps<{ datapublikasisdm: any, upts: any[] }>()

const form = useForm({
  _method: 'put',
  upt_id: String(props.datapublikasisdm.upt_id),
  tanggal_input: props.datapublikasisdm.tanggal_input,
  nama_kegiatan: props.datapublikasisdm.nama_kegiatan,
  tanggal_publikasi: props.datapublikasisdm.tanggal_publikasi,
  uraian_singkat: props.datapublikasisdm.uraian_singkat,
  media_publikasi: props.datapublikasisdm.media_publikasi,
  link_berita: props.datapublikasisdm.link_berita || '',
})

function submit() {
  form.post(`/admin/data-publikasi-sdms/${props.datapublikasisdm.id}`)
}
</script>
