...
const form = useForm({
  ...
  belanja_pegawai_pagu: 0, belanja_pegawai_realisasi: 0,
  belanja_barang_pagu: 0, belanja_barang_realisasi: 0,
  belanja_modal_pagu: 0, belanja_modal_realisasi: 0,
  belanja_listrik_pagu: 0, belanja_listrik_realisasi: 0,
  belanja_telpon_pagu: 0, belanja_telpon_realisasi: 0,
  belanja_internet_pagu: 0, belanja_internet_realisasi: 0,
  belanja_pos_pagu: 0, belanja_pos_realisasi: 0,
  
  bama_nomor_kontrak: '',
  bama_pagu_anggaran: 0,
  bama_realisasi_anggaran: 0,
  bama_nama_penyedia: '',
  bama_nomor_bast: '',
  bama_tanggal_bast: '',
...
function submit() {
  form.post('/admin/data-realisasi-anggarans')
}
</script>
